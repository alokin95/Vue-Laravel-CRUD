...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_paginate__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vue_paginate___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_vue_paginate__);
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_2_vue_paginate___default.a);
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]);

 // Routes from routes.js file
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Notification__ = __webpack_require__(40);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__UserInfo__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__UserInfo___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__UserInfo__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        getSingleUser: function getSingleUser(id) {
            ...
            axios.get('user/' + id).then(function (_ref2) {
                var data = _ref2.data;
    ...
    components: {
        ...
        Info: __WEBPACK_IMPORTED_MODULE_1__UserInfo___default.a
    },
    ...
    created: function created() {
        ...
        Event.$on('fetchUsers', function () {
            return _this3.getUsers();
        });
        Event.$on('user-deleted', function (id) {
            _this3.deleteUser(id);
            _this3.isInfoVisible = false;
            _this3.user = "";
        });
    }
...
Component.options.__file = "resources\\assets\\js\\views\\Notification.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-fffed410", Component.options)
  } else {
    hotAPI.reload("data-v-fffed410", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-fffed410", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\views\\UserInfo.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-052720b4", Component.options)
  } else {
    hotAPI.reload("data-v-052720b4", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
  ...
  return _c("div", { staticClass: "modal is-active" }, [
    ...
    _c("div", { staticClass: "modal-card" }, [
      _c("header", { staticClass: "modal-card-head" }, [
        _c("p", { staticClass: "modal-card-title" }, [_vm._v("User details")]),
        _vm._v(" "),
        _c("button", {
          staticClass: "delete",
        ...
        _c("div", { staticClass: "card" }, [
          ...
          _c("div", { staticClass: "card-content" }, [
            _c("div", { staticClass: "content" }, [
              ...
              _vm._v(" "),
              _c("p", [_vm._v(" " + _vm._s(_vm.user.card_type) + " ")]),
              _vm._v(" "),
              _c("p", [_vm._v(" " + _vm._s(_vm.user.card_number) + " ")]),
              _vm._v(" "),
              _c("p", [_vm._v(" " + _vm._s(_vm.user.info) + " ")]),
              _vm._v(" "),
              _c("br"),
              _vm._v(" "),
              _c("time", { attrs: { datetime: "2016-1-1" } }, [
                _vm._v("Membership since: " + _vm._s(_vm.user.created_at))
              ])
            ])
          ]),
          _vm._v(" "),
            ...
            [
              _c(
                "router-link",
                {
                  ...
                  attrs: {
                    to: { name: "edit", params: { userId: _vm.user.id } }
                  }
                },
                [_vm._v("\n              Edit\n            ")]
              ),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-052720b4", module.exports)
  }
}
...
var render = function() {
  ...
  return _c(
    ...
    [
      _vm.message
        ? _c("Notification", { attrs: { message: _vm.message } })
        : _vm._e(),
      _vm._v(" "),
      _c("div", { staticClass: "field" }, [
        _c("div", { staticClass: "control" }, [
          _c("input", {
            ...
            attrs: { type: "text", placeholder: "Search members by name" },
      ...
      _vm._v(" "),
      _c("paginate", { attrs: { name: "users", list: _vm.users, per: 5 } }, [
            ...
            _vm._l(_vm.paginated("users"), function(user) {
              return _c(
                ...
                [
                  ...
                  _vm._v(" "),
                  _c("td", [_vm._v(" " + _vm._s(user.card_type) + " ")]),
                  _vm._v(" "),
                  ...
                  _c("th", [
                    _c(
                      "a",
                      {
                        staticClass: "button is-danger is-small user-delete",
                        on: {
                          click: function($event) {
      ...
      _c("br"),
      _vm._v(" "),
      _c("paginate-links", { attrs: { for: "users" } })
    ],
    1
  )
}
...
Component.options.__file = "resources\\assets\\js\\views\\AddUser.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-099cbf8f", Component.options)
  } else {
    hotAPI.reload("data-v-099cbf8f", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    data: function data() {
        return {
            user: {},
            errors: __WEBPACK_IMPORTED_MODULE_0__Validator__["a" /* default */]
        };
    },
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("a", { staticClass: "button is-outlined", on: { click: _vm.back } }, [
      _vm._v("Back")
    ]),
    _vm._v(" "),
    _c("br"),
    ...
    _c(
      ...
      [
        ...
        _vm._v(" "),
        _c("div", { staticClass: "field" }, [
          _c("label", { staticClass: "label" }, [_vm._v("Card number")]),
          _vm._v(" "),
          _c("div", { staticClass: "control has-icons-left has-icons-right" }, [
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.user.card_number,
                  expression: "user.card_number"
                }
              ],
              staticClass: "input",
              attrs: {
              ...
              domProps: { value: _vm.user.card_number },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.user, "card_number", $event.target.value)
                }
              }
            }),
            _vm._v(" "),
        ...
        _vm._v(" "),
        _c("div", { staticClass: "field" }, [
          _c("label", { staticClass: "label" }, [_vm._v("Card type")]),
          _vm._v(" "),
          _c("div", { staticClass: "control has-icons-left has-icons-right" }, [
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.user.card_type,
                  expression: "user.card_type"
                }
              ],
              staticClass: "input",
              attrs: {
              ...
              domProps: { value: _vm.user.card_type },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.user, "card_type", $event.target.value)
                }
              }
            }),
            _vm._v(" "),
        ...
        _vm._v(" "),
        _c("div", { staticClass: "field" }, [
          _c("label", { staticClass: "label" }, [_vm._v("Info")]),
          _vm._v(" "),
          _c("div", { staticClass: "control has-icons-left has-icons-right" }, [
            _c("textarea", {
              directives: [
              ...
              on: {
                input: function($event) {
                  ...
                  _vm.$set(_vm.user, "info", $event.target.value)
                }
              }
            }),
            _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-099cbf8f", module.exports)
  }
}
...
Component.options.__file = "resources\\assets\\js\\views\\EditUser.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-afc618fc", Component.options)
  } else {
    hotAPI.reload("data-v-afc618fc", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
    ...
    _c("div", { staticClass: "container" }, [
      _c("div", { staticClass: "field is-grouped" }, [
        _c("p", { staticClass: "control" }, [
          _c("a", { staticClass: "button is-link", on: { click: _vm.back } }, [
            _vm._v("\n            Back\n          ")
          ])
        ]),
        _vm._v(" "),
        _c("p", { staticClass: "control" }, [
          _c(
            "a",
            { staticClass: "button is-danger", on: { click: _vm.deleteUser } },
            [_vm._v("\n            Delete user\n          ")]
          )
        ])
      ]),
      _vm._v(" "),
      _c("h1", { staticClass: "title" }, [_vm._v("Edit user information")]),
      _vm._v(" "),
      _c("hr"),
      _vm._v(" "),
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "field is-grouped" }, [
      _c("div", { staticClass: "control" }, [
        _c("button", { staticClass: "button is-link" }, [_vm._v("Edit")])
      ])
    ])
  }
]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-afc618fc", module.exports)
  }
}
